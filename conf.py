...
.. only:: html
    ...
    .. nbinfo::
        ...
        :raw-html:`<br/><a href='https://colab.research.google.com/github/csmastersUH/data_analysis_with_python_summer_2021/blob/master/{{ docname2 }}'><img align='left' src='https://colab.research.google.com/assets/colab-badge.svg' alt='Open in Colab' title='Open and Execute in Google Colaboratory' /></a>`
        :raw-html:`<br/>`

    __ https://github.com/csmastersUH/data_analysis_with_python_summer_2021/blob/master/{{ docname2 }}
